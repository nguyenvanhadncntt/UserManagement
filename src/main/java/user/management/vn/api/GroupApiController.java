...
public class GroupApiController {
	...
	public ResponseEntity<Object> removeUserFromGroup(@PathVariable("groupId") Long groupId,@RequestParam("userIds")List<Long> userIds){
		boolean result = groupService.removeUseFromGroup(groupId, userIds);
		if(!result) {
